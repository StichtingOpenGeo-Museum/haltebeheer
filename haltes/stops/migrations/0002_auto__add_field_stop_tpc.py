...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stop.tpc'
        db.add_column('stops_stop', 'tpc', self.gf('django.db.models.fields.CharField')(default='', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Stop.tpc'
        db.delete_column('stops_stop', 'tpc')
